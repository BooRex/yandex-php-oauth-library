...
if [ "$TRAVIS_PHP_VERSION" != "7.2" ] && [ "$TRAVIS_PHP_VERSION" != "hhvm" ]; then
...
if [ "$TRAVIS_REPO_SLUG" == "boorex/yandex-php-oauth-library" ] && [ "$TRAVIS_PULL_REQUEST" == "false" ] && [ "$TRAVIS_PHP_VERSION" == "5.6" ]; then
