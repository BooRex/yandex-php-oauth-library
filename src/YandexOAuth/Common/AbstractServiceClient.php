 ...
 * @namespace
 */
namespace YandexOAuth\Common;

use GuzzleHttp\Client;
use GuzzleHttp\ClientInterface;
use GuzzleHttp\Exception\ClientException;
use GuzzleHttp\Psr7\Response;
use YandexOAuth\Common\Exception\MissedArgumentException;
use YandexOAuth\Common\Exception\ProfileNotFoundException;
use YandexOAuth\Common\Exception\YandexException;

/**
 * Class AbstractServiceClient
 *
 * @package YandexOAuth\Common
 *
